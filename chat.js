...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        :root {
            ...
            --border: rgba(0,217,255,0.code-bg: #1a1a2e;
        }
    ...
    <script async src="https://cse.google.com/cse.js?cx=a27ba8624db9440d0"></script>
</head>
<body>
    <!-- 🎨 FONDO DE PARTÍCULAS -->
    ...
    <div class="container">
        ...
        <div class="chat-area" id="chatArea">
            ...
            <div class="welcome-center" id="welcomeCenter">
                <div class="welcome-title" id="saludoTitle días</div>
                ...
                <div class="input-actions">
                    ...
                    <button class="attach-btn" title="Adjuntar archivo">
                        <svg width="18" height="18" fill="#fff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16.5 6v11.5c0 2.21-1.79 4-4 4s-4-1.79-4-4V5c0-1.38 1.12-2.5 2.5-2.5s2.5 1.12 2.5 2.5v10.5c0 .55-.45 1-1 1s-1-.45-1-1V6H10v9.5c0 1.38 1.12 2.5 2.5 2.5s2.5-1.12 2.5-2.5V5c0-2.21-1.79-4-7 2.79 7 5v12.5c0 3.04 2.46 5.5 5.5 5.5s5.5-2.46 5.5-5.5V6h-1.5z"/>
                        </svg>
                    </button>
    ...
    <script>
        ...
        class OcladeBrain {
            ...
            analizar(mensaje) {
                ...
                // ✅ AHORA USA CHAT.JS PARA RESPUESTAS INTELIGENTES
            ...
            // 🔥 ESTA FUNCIÓN AHORA USA CHAT.JS + BUSCA EN INTERNET SI NO ENCUENTRA
            respuestaInteligente(m) {
                // Asegúrate de que chat.js esté cargado
                if (window.OcladeChat) {
                    const respuesta = OcladeChat.generate(m);
                    // Si chat.js no da una respuesta útil, buscamos en internet
                    if (respuesta.includes("no tengo una respuesta")) {
                        return this.buscarEnInternet(m);
                    }
                    return respuesta;
                } else {
            ...
            // 🔍 FUNCIÓN QUE BUSCA EN INTERNET
            buscarEnInternet(query) {
                // Creamos un div para el widget de búsqueda
                const searchDiv = document.createElement('div');
                searchDiv.className = 'gsc-control-cse';

                // Creamos un div contenedor para el chat
                const aiMsg = document.createElement('div');
                aiMsg.className = 'message ai-msg';
                aiMsg.innerHTML = `
                    <p>🔍 <b>No encontré eso en mi base local.</b> Voy a buscar en la web por ti...</p>
                    <div id="google-search-container-${Date.now()}"></div>
                `;

                // Insertamos el mensaje en el chat
                chatArea.appendChild(aiMsg);
                chatArea.scrollTop = chatArea.scrollHeight;

                // Ahora insertamos el widget en el contenedor específico
                const container = aiMsg.querySelector('[id^="google-search-container"]');
                if (container) {
                    container.appendChild(searchDiv);
                    
                    // Forzar recarga del script de Google CSE
                    if (window.google && google.search && google.search.cse) {
                        google.search.cse.element.renderAll();
                    }
                }

                return "🔍 Estoy buscando en internet por ti..."; // Este mensaje no se mostrará porque ya se insertó el widget
            }
        }
        ...
        function sendMessage() {
            ...
            setTimeout(() => {
                ...
                // Solo mostramos la respuesta si no se insertó el widget de búsqueda
                if (!respuesta.includes("buscando en internet")) {
                    const aiMsg = document.createElement('div');
                    aiMsg.className = 'message ai-msg';
        ...
        function hide            const thinking = document.getElementById('thinking');
